...
public class Bala {
     ...
     * Crea una bala.
     *
     * @param dibuix Dibuix de la bala
     * @param posx posició inicial de la bala
     * @param posy posició inicial de la bala
     * @param destix destí de la bala
     * @param destiy destí de la bala
     */
    public Bala(final Image dibuix, final int posx, final int posy,
        ...
        int c = calculaDistancia();
        direccioX = (destiX - imatge.getX()) / c;
        direccioY = (destiY - imatge.getY()) / c;
    }
    ...
    public final int mou() {
        ...
        getImatge().move(direccioX * VELOCITATMAXIMA,
                direccioY * VELOCITATMAXIMA);
        ...
        if (calculaDistancia() < VELOCITATMAXIMA) {
           ...
           if (direccioX != 0 && direccioY != 0) {
               ...
               GImage explota = new GImage("explosio.png",
