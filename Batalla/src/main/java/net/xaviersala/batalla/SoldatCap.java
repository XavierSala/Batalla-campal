 ...
 *
 * <p>
 * La idea és que no ataqui mai sinó que es quedi pel darrera dels seus soldats
...
public class SoldatCap extends SoldatGlobal {
  ...
  /**
   * El rei no es mou però li donem un zero per indicar que no cal tenir-lo en
   * compte per arribar a l'altre costat.
   *
   * @return sempre zero
   */
  @Override
  public final int mou() {
    ...
    getImatge().move(0, dirY * Aleatori.obtenir(VELOCITATMAXIMA));
