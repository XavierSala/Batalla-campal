...
/**
 * Defineix què és el que ha de fer un soldat per poder ser considerat soldat.
 *
 * @author xavier
 *
 */
public interface Soldat {
   ...
   *
   * @param posX
   *          destí a on ha d'anar
   * @param posY
   *          destí a on ha d'anar
   */
  void posiciona(final int posX, final int posY);

  /**
   * Retorna el rectangle que envolta la imatge del soldat.
